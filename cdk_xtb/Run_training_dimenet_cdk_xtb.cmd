...
python Equilibrium.py --root_path "Equilibrium" --cdk_path "\percorso\descrittori\cdk" --xtb_path "\percorso\descrittori\xtb" > log_Equilibrium_script_cdk_xtb.txt 2>&1
