...
parser = argparse.ArgumentParser(description="Training con descrittori cdk e xtb sempre attivi")
parser.add_argument('--root_path', type=str, required=True,help="Percorso della cartella principale contenente i dati")
parser.add_argument('--cdk_path', type=str, required=True,help="Percorso dei descrittori cdk")
