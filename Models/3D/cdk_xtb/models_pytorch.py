...
class DimeNet(torch.nn.Module):
    ...
    def __init__(
        ...
        self.input_dim = hidden_channels + cdk_dim + xtb_dim
        self.cutoff = cutoff
        ...
        self.emb = EmbeddingBlock(num_radial, hidden_channels, act, cdk_dim=cdk_dim, xtb_dim=xtb_dim)
    ...
    def forward(
        ...
        x = self.emb(z, rbf, i, j, data.cdk_desc, data.xtb_desc)
