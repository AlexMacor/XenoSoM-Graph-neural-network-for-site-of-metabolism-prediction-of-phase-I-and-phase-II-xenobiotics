...
parser = argparse.ArgumentParser(description="Training con i descrittori CDK")
...
parser.add_argument('--descr_path', type=str, required=True, help="Percorso della cartella dei descrittori CDK")
