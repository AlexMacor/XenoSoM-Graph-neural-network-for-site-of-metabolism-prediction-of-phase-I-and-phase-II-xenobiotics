...
df_all_molecules_db = pd.read_csv(r'\MetabolEX_DB_SubstratesSDF-1.csv') # path the initial csv file 
output_path = r'path to generate folder' # r'C:\Users\USER NAME\Desktop\1\Dataset'
...
for rxn in rxn_classes:
    ...
    print(f"Creata cartella: {folder_path}")
...
for _, row in df_all_molecules_db.iterrows():
    ...
    print(f"Cartella di classe o sottoclasse creata: {name_path}")
