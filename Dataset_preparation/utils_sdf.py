...
def preprocessing_sdf(sdf_m, multi_sdfs, cln=False):
    """
    Split di un file SDF multi-molecola in più file .sdf.
    Se clean=True, corregge anche i file aggiungendo le righe mancanti dopo 'M  V30 END BOND'.
    """
    ...
    if cln:
        ...
        for sdf_file in sdf_files:
            ...
            #print(f"File '{sdf_file}' pronto per calcolo cdk/xtb")
    ...
    for sdf_file in sdf_files:
        ...
        if mol_id not in valid_ids:  # <-- qui devi usare valid_ids, non valid_molecules
...
if __name__ == "__main__":
    ...
    sdf_m = r"\MetabolEX_DB_SubstratesSDF.sdf" # path with the multi sdf file 
