...
parser = argparse.ArgumentParser(
    description="Inference glutathione conjugation")
...
ELEM_LIST = [6,7,8,9,15,16,17,35,53]  # B, C, N, O, F, Al, Si, P, S, Cl,Fe,Ge, As,Se, Br, I, Pt, Au #
...
root_path = r'\GlutathioneConjugation'
subclass_folders = [
...
final_csv_path = os.path.join(file_sdf_inf_p, "gluthathioneconjugation_subclasses_rdkit_inf.csv")
